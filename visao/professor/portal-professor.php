...
<head>
    ...
    <style>
      .jumbotron{
        background: url('../../img/new/s-bg.jpg') !important;
      }
    </style>
</head>
<body>
...
<div class="jumbotron">
  ...
  <h1 class="h1hello display-4 form-group d-flex justify-content-center">Olá, Prof.
    <?php
        $pDAO = new PessoaDAO();
  ...
  <hr class="my-4">
  <h2>
    Seja bem-vindo ao seu portal do professor!
  </h2>
  <!--<p class="lead">
...
<div class="row">
  ...
  <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
    <div class="hovereffect">
        ...
        <div class="overlay">
           <h2>Meus Dados</h2>
           <a class="info" href="dados-professor.php">Clique aqui</a>
        </div>
    </div>
  </div>
  <hr>
  <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
    <div class="hovereffect">
        ...
        <div class="overlay">
           ...
           <a class="info" href="notas-professor.php">Clique aqui</a>
        </div>
    </div>
  </div>
  <hr>
  <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
    <div class="hovereffect">
        ...
        <div class="overlay">
           ...
           <a class="info" href="cursos-professor.php">Clique aqui</a>
        </div>
    </div>
  </div>
  <hr>
