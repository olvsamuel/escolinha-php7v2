...
<table class="table table-hover table-dark">
  ...
  <tbody>
    ...
    foreach ($ps as $p) {
      ...
      echo "<td>$p->sexo</td>";
      echo "<td>$p->cpf</td>";
      echo "<td><a href='alterar-professor.php?id=$p->idpessoa' class='btn btn-warning'>Alterar</a></td>";
    echo "</tr>";
    }
...
<form name="pdfaluno" method="post" action="">
  <div class="form-group">
    <input type="submit" name="pdfaluno" value="PDF Pessoa" class="btn btn-primary">
  </div>
</form>
